...
#define __HAL_DMA_REMAP_CHANNEL_ENABLE(__DMA_REMAP__)                                                                                               \
  ...
  {                                                                                                                                                 \
    ...
    (((__DMA_REMAP__) & HAL_REMAP_CFGR3_MASK) ? (SYSCFG->CFGR3 |= ((__DMA_REMAP__) & ~HAL_REMAP_CFGR3_MASK)) : (SYSCFG->CFGR1 |= (__DMA_REMAP__))); \
  } while (0U)
...
#define __HAL_REMAPTRIGGER_ENABLE(__TRIGGER_REMAP__)                                                                                                            \
  ...
  {                                                                                                                                                             \
    ...
    (((__TRIGGER_REMAP__) & HAL_REMAP_CFGR3_MASK) ? (SYSCFG->CFGR3 |= ((__TRIGGER_REMAP__) & ~HAL_REMAP_CFGR3_MASK)) : (SYSCFG->CFGR1 |= (__TRIGGER_REMAP__))); \
  } while (0U)
