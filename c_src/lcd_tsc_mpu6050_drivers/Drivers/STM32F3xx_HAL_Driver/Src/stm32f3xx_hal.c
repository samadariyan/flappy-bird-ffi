...
#define __STM32F3xx_HAL_VERSION ((__STM32F3xx_HAL_VERSION_MAIN << 24U) | (__STM32F3xx_HAL_VERSION_SUB1 << 16U) | (__STM32F3xx_HAL_VERSION_SUB2 << 8U) | (__STM32F3xx_HAL_VERSION_RC))
